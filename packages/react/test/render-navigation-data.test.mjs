...
assert.match(listMarkup, /role="listbox"/);
assert.match(listMarkup, /aria-label="Fleet tasks"/);
assert.match(listMarkup, /aria-activedescendant="[^"]+option-0"/);
...
assert.match(listMarkup, /<span class="list__item"/);
assert.match(listMarkup, /data-key="docs"/);
assert.match(listMarkup, /role="option"/);
assert.match(listMarkup, /aria-selected="true"/);
