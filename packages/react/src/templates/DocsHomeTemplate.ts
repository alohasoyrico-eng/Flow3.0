...
export const DocsHomeTemplate = forwardRef<HTMLElement, DocsHomeTemplateProps>(function DocsHomeTemplate({
  title,
  description,
  metadata = [],
  coverage,
  ...
  return React.createElement(
    ...
    React.createElement(Surface, { surfaceRole: "section", density, tone: "default", elevation: "none", "data-flow-slot": "docs-home.main" },
      ...
      React.createElement(DocumentationSection, { title: "Status", density, "data-flow-slot": "docs-home.status" }, status),
      metadata.length ? React.createElement(ArtifactMetadataBar, { items: metadata, density, "data-flow-slot": "docs-home.metadata" }) : null,
      children,
    ),
  );
}) as DocsHomeTemplateComponent;
