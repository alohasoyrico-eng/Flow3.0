export type ComponentContractProp = {
  name: string;
  type: string;
  required: boolean;
};
...
export type ComponentContract = {
  ...
  props: readonly ComponentContractProp[];
...
export const componentContracts = {
  ...
  input: {
    ...
    props: [
      ...
      { name: "clearable", type: "boolean", required: false },
  ...
  select: {
    ...
    accessibility: [
      ...
      "Use searchable and clearable for long but still closed option sets instead of shipping a separate Combobox source.",
      "Announce empty and loading searchable results with visible status copy.",
  ...
  pagination: {
    ...
    props: [
      ...
      { name: "label", type: "string", required: false },
      { name: "previousLabel", type: "string", required: false },
      { name: "nextLabel", type: "string", required: false },
      { name: "firstLabel", type: "string", required: false },
      { name: "lastLabel", type: "string", required: false },
      { name: "previousJumpLabel", type: "string", required: false },
      { name: "nextJumpLabel", type: "string", required: false },
      { name: "getPageLabel", type: "(page: number) => string", required: false },
      { name: "variant", type: "\"numbered\" | \"jump\"", required: false },
      { name: "jumpSize", type: "number", required: false },
      { name: "state", type: "\"default\" | \"hover\" | \"focus\" | \"selected\" | \"disabled\"", required: false },
      { name: "density", type: "\"sm\" | \"md\" | \"lg\"", required: false },
      { name: "fullWidth", type: "boolean", required: false },
      { name: "disabled", type: "boolean", required: false },
      { name: "onPageChange", type: "(page: number, event: KeyboardEvent<HTMLElement> | MouseEvent<HTMLButtonElement>) => void", required: false }
    ],
    accessibility: [
      "Use nav with an accessible label.",
      "Mark the current page with aria-current.",
      "Disable unavailable previous or next actions.",
      "Support ArrowLeft/ArrowRight, Home/End, and PageUp/PageDown for jump pagination while focus is inside the navigation.",
      "Use jump controls only for bounded ranges where first/last or fixed-size page jumps reduce scanning.",
  ...
  datePicker: {
    ...
    element: "div",
    purpose: "Capture one operational date or one bounded date range with visible label, readable value, calendar affordance, locale rules, disabled dates, presets, and validation states.",
    variants: ["calendar"],
    intents: ["input"],
    states: ["default", "hover", "focus", "selected", "warning", "error", "disabled"],
    props: [
      { name: "label", type: "string", required: true },
      { name: "mode", type: "\"single\" | \"range\"", required: false },
      { name: "value", type: "string | DatePickerRangeValue", required: false },
      ...
      { name: "presetItems", type: "DatePickerPreset[]", required: false },
      { name: "density", type: "\"sm\" | \"md\" | \"lg\"", required: false },
      { name: "state", type: "\"default\" | \"hover\" | \"focus\" | \"selected\" | \"warning\" | \"error\" | \"disabled\"", required: false },
      { name: "invalid", type: "boolean", required: false },
      { name: "disabled", type: "boolean", required: false },
      { name: "open", type: "boolean", required: false },
      { name: "onValueChange", type: "(value: string | DatePickerRangeValue) => void", required: false },
      { name: "onOpenChange", type: "(open: boolean) => void", required: false }
    ],
    accessibility: [
      "Expose label, selected date, dialog state, and disabled dates.",
      "Keep the selected date or selected range visible as text.",
      "Support keyboard entry, keyboard day selection, direct month/year selection, range selection, presets, and native date input fallback.",
      "Escape closes the calendar and restores focus to the trigger.",
      "Use scheduling patterns for composed calendar processes."
    ]
  },
  dateRangePicker: {
...
export type ComponentContractId = keyof typeof componentContracts;
