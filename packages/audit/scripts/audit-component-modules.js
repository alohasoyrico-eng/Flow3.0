...
const moduleRules = [
  ...
  },
  {
    ...
    exports: ["createErrorPanel", "createProgressIndicator", "createSkeleton", "createSpinner"],
    publicExports: [],
    internalExports: ["createErrorPanel", "createProgressIndicator", "createSkeleton", "createSpinner"],
  },
  {
    id: "fields",
