...
const moduleRules = [
  ...
  },
  {
    ...
    publicExports: ["createChartPanel"],
    internalExports: ["createCardSummary", "createMovementRow", "createQuickAction", "createRouteSummary", "createStationPin", "createTable"],
  },
  {
    id: "display",
  ...
  },
  {
    ...
    publicExports: ["createMotionBoundary"],
