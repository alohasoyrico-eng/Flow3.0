...
const moduleRules = [
  ...
  },
  {
    ...
    publicExports: ["createAuditEvent", "createKpiTile", "createList"],
  ...
  },
  {
    ...
    publicExports: ["createEmptyState", "createErrorPanel", "createProgressIndicator", "createSpinner"],
    internalExports: ["createSkeleton"],
  },
  {
    id: "fields",
  ...
  },
  {
    ...
    publicExports: ["createSegmentedControl", "createSlider", "createTabs", "createTreeView"],
    internalExports: ["createAccordion"],
  },
  {
    id: "navigation",
  ...
  },
  {
    ...
    publicExports: ["createDialog", "createDrawer", "createMenu", "createPopover"],
    internalExports: ["createToast", "createTransitionalTooltip"],
  },
  {
    id: "specialized-inputs",
    file: "packages/components/src/components/specialized-inputs.js",
    exports: ["createTransitionalDatePicker", "createTransitionalDateRangePicker", "createTransitionalPhoneInput", "createTransitionalSecurityCodeInput"],
    publicExports: [],
    internalExports: ["createTransitionalDatePicker", "createTransitionalDateRangePicker", "createTransitionalPhoneInput", "createTransitionalSecurityCodeInput"],
  },
  {
    id: "security",
