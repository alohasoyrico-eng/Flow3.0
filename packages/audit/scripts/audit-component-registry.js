...
function checkComponentRegistry() {
  ...
  for (const component of requiredComponentContracts) {
    ...
    if (["button", "checkbox", "icon-button", "input", "radio-button", "select", "switch", "text-area"].includes(component)) {
      ...
      const factory = component === "button" ? "createButton" : component === "checkbox" ? "createTransitionalChoiceCheckbox" : component === "icon-button" ? "createIconButton" : component === "input" ? "createTransitionalFieldInput" : component === "radio-button" ? "createTransitionalChoiceRadioButton" : component === "switch" ? "createSwitch" : component === "text-area" ? "createTransitionalFieldTextArea" : "createTransitionalFieldSelect";
