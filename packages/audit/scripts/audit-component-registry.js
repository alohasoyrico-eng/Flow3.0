...
function checkComponentRegistry() {
  ...
  for (const component of requiredComponentContracts) {
    ...
    if (["avatar", "badge", "button", "card-expiry-input", "card-number-input", "card-security-code-input", "checkbox", "chip", "code-input", "date-picker", "date-range-picker", "empty-state", "icon-button", "input", "phone-input", "radio-button", "select", "skeleton", "switch", "tag", "text-area", "tooltip"].includes(component)) {
      const label = component === "avatar" ? "Avatar" : component === "badge" ? "Badge" : component === "button" ? "Button" : component === "card-expiry-input" ? "Card Expiry Input" : component === "card-number-input" ? "Card Number Input" : component === "card-security-code-input" ? "Card Security Code Input" : component === "checkbox" ? "Checkbox" : component === "chip" ? "Chip" : component === "code-input" ? "Code Input" : component === "date-picker" ? "Date Picker" : component === "date-range-picker" ? "Date Range Picker" : component === "empty-state" ? "Empty State" : component === "icon-button" ? "Icon Button" : component === "input" ? "Input" : component === "phone-input" ? "Phone Input" : component === "radio-button" ? "Radio Button" : component === "skeleton" ? "Skeleton" : component === "switch" ? "Switch" : component === "tag" ? "Tag" : component === "text-area" ? "Text Area" : component === "tooltip" ? "Tooltip" : "Select";
      const factory = component === "avatar" ? "createTransitionalAvatar" : component === "badge" ? "createTransitionalBadge" : component === "button" ? "createTransitionalActionButton" : component === "card-expiry-input" ? "createTransitionalPaymentCardExpiryInput" : component === "card-number-input" ? "createTransitionalPaymentCardNumberInput" : component === "card-security-code-input" ? "createTransitionalPaymentCardSecurityCodeInput" : component === "checkbox" ? "createTransitionalChoiceCheckbox" : component === "chip" ? "createTransitionalChip" : component === "code-input" ? "createTransitionalSecurityCodeInput" : component === "date-picker" ? "createTransitionalDatePicker" : component === "date-range-picker" ? "createTransitionalDateRangePicker" : component === "empty-state" ? "createEmptyState" : component === "icon-button" ? "createTransitionalActionIconButton" : component === "input" ? "createTransitionalFieldInput" : component === "phone-input" ? "createTransitionalPhoneInput" : component === "radio-button" ? "createTransitionalChoiceRadioButton" : component === "skeleton" ? "createSkeleton" : component === "switch" ? "createTransitionalChoiceSwitch" : component === "tag" ? "createTransitionalTag" : component === "text-area" ? "createTransitionalFieldTextArea" : component === "tooltip" ? "createTransitionalTooltip" : "createTransitionalFieldSelect";
  ...
  for (const snippet of ["componentDemoProps", "reactAvatarDemo", 'data-react-component="avatar"', 'if (component === "avatar") return reactAvatarDemo(demo);', "reactBadgeDemo", 'data-react-component="badge"', 'if (component === "badge") return reactBadgeDemo(demo);', "reactChipDemo", 'data-react-component="chip"', 'if (component === "chip") return reactChipDemo(demo);', "reactTagDemo", 'data-react-component="tag"', 'if (component === "tag") return reactTagDemo(demo);', "reactButtonDemo", 'data-react-component="button"', 'if (component === "button") return reactButtonDemo(demo);', "reactCardExpiryInputDemo", 'data-react-component="card-expiry-input"', 'if (component === "card-expiry-input") return reactCardExpiryInputDemo(demo);', "reactCardNumberInputDemo", 'data-react-component="card-number-input"', 'if (component === "card-number-input") return reactCardNumberInputDemo(demo);', "reactCardSecurityCodeInputDemo", 'data-react-component="card-security-code-input"', 'if (component === "card-security-code-input") return reactCardSecurityCodeInputDemo(demo);', "reactCheckboxDemo", 'data-react-component="checkbox"', 'if (component === "checkbox") return reactCheckboxDemo(demo);', "reactCodeInputDemo", 'data-react-component="code-input"', 'if (component === "code-input") return reactCodeInputDemo(demo);', "reactDatePickerDemo", 'data-react-component="date-picker"', 'if (component === "date-picker") return reactDatePickerDemo(demo);', "reactDateRangePickerDemo", 'data-react-component="date-range-picker"', 'if (component === "date-range-picker") return reactDateRangePickerDemo(demo);', "reactEmptyStateDemo", 'data-react-component="empty-state"', 'if (component === "empty-state") return reactEmptyStateDemo(demo);', "reactInlineValidationDemo", 'data-react-component="inline-validation"', 'if (component === "inline-validation") return reactInlineValidationDemo(demo);', "reactInputDemo", 'data-react-component="input"', 'if (component === "input") return reactInputDemo(demo);', "reactPhoneInputDemo", 'data-react-component="phone-input"', 'if (component === "phone-input") return reactPhoneInputDemo(demo);', "reactProgressIndicatorDemo", 'data-react-component="progress-indicator"', 'if (component === "progress-indicator") return reactProgressIndicatorDemo(demo);', "reactRadioButtonDemo", 'data-react-component="radio-button"', 'if (component === "radio-button") return reactRadioButtonDemo(demo);', "reactSelectDemo", 'data-react-component="select"', 'if (component === "select") return reactSelectDemo(demo);', "reactSegmentedControlDemo", 'data-react-component="segmented-control"', 'if (component === "segmented-control") return reactSegmentedControlDemo(demo);', "reactSkeletonDemo", 'data-react-component="skeleton"', 'if (component === "skeleton") return reactSkeletonDemo(demo);', "reactSpinnerDemo", 'data-react-component="spinner"', 'if (component === "spinner") return reactSpinnerDemo(demo);', "reactSwitchDemo", 'data-react-component="switch"', 'if (component === "switch") return reactSwitchDemo(demo);', "reactTextAreaDemo", 'data-react-component="text-area"', 'if (component === "text-area") return reactTextAreaDemo(demo);']) {
