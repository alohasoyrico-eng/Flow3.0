...
function checkComponentRegistry() {
  ...
  for (const component of requiredComponentContracts) {
    ...
    if (["button", "card-expiry-input", "card-number-input", "card-security-code-input", "checkbox", "code-input", "date-picker", "date-range-picker", "icon-button", "input", "phone-input", "radio-button", "select", "switch", "text-area"].includes(component)) {
