...
function checkComponentRegistry() {
  ...
  for (const component of requiredComponentContracts) {
    ...
    if (["button", "card-expiry-input", "card-number-input", "card-security-code-input", "checkbox", "icon-button", "input", "radio-button", "select", "switch", "text-area"].includes(component)) {
