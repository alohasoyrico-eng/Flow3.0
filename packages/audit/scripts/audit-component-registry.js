...
function checkComponentRegistry() {
  ...
  for (const component of requiredComponentContracts) {
    ...
    if (["button", "card-expiry-input", "card-number-input", "card-security-code-input", "checkbox", "code-input", "date-picker", "icon-button", "input", "phone-input", "radio-button", "select", "switch", "text-area"].includes(component)) {
      const label = component === "button" ? "Button" : component === "card-expiry-input" ? "Card Expiry Input" : component === "card-number-input" ? "Card Number Input" : component === "card-security-code-input" ? "Card Security Code Input" : component === "checkbox" ? "Checkbox" : component === "code-input" ? "Code Input" : component === "date-picker" ? "Date Picker" : component === "icon-button" ? "Icon Button" : component === "input" ? "Input" : component === "phone-input" ? "Phone Input" : component === "radio-button" ? "Radio Button" : component === "switch" ? "Switch" : component === "text-area" ? "Text Area" : "Select";
