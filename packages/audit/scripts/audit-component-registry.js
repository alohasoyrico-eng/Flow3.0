...
function checkComponentRegistry() {
  ...
  for (const component of requiredComponentContracts) {
    ...
    if (["button", "card-expiry-input", "card-number-input", "checkbox", "icon-button", "input", "radio-button", "select", "switch", "text-area"].includes(component)) {
      const label = component === "button" ? "Button" : component === "card-expiry-input" ? "Card Expiry Input" : component === "card-number-input" ? "Card Number Input" : component === "checkbox" ? "Checkbox" : component === "icon-button" ? "Icon Button" : component === "input" ? "Input" : component === "radio-button" ? "Radio Button" : component === "switch" ? "Switch" : component === "text-area" ? "Text Area" : "Select";
      const factory = component === "button" ? "createTransitionalActionButton" : component === "card-expiry-input" ? "createTransitionalPaymentCardExpiryInput" : component === "card-number-input" ? "createTransitionalPaymentCardNumberInput" : component === "checkbox" ? "createTransitionalChoiceCheckbox" : component === "icon-button" ? "createTransitionalActionIconButton" : component === "input" ? "createTransitionalFieldInput" : component === "radio-button" ? "createTransitionalChoiceRadioButton" : component === "switch" ? "createTransitionalChoiceSwitch" : component === "text-area" ? "createTransitionalFieldTextArea" : "createTransitionalFieldSelect";
