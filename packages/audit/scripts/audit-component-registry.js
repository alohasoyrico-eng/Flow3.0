...
function checkComponentRegistry() {
  ...
  for (const component of requiredComponentContracts) {
    ...
    if (["avatar", "badge", "button", "card-expiry-input", "card-number-input", "card-security-code-input", "checkbox", "chip", "code-input", "date-picker", "date-range-picker", "icon-button", "input", "phone-input", "radio-button", "select", "skeleton", "switch", "tag", "text-area", "tooltip"].includes(component)) {
