...
function checkComponentRegistry() {
  ...
  for (const component of requiredComponentContracts) {
    ...
    if (["badge", "button", "card-expiry-input", "card-number-input", "card-security-code-input", "checkbox", "code-input", "date-picker", "date-range-picker", "icon-button", "input", "phone-input", "radio-button", "select", "switch", "tag", "text-area"].includes(component)) {
      const label = component === "badge" ? "Badge" : component === "button" ? "Button" : component === "card-expiry-input" ? "Card Expiry Input" : component === "card-number-input" ? "Card Number Input" : component === "card-security-code-input" ? "Card Security Code Input" : component === "checkbox" ? "Checkbox" : component === "code-input" ? "Code Input" : component === "date-picker" ? "Date Picker" : component === "date-range-picker" ? "Date Range Picker" : component === "icon-button" ? "Icon Button" : component === "input" ? "Input" : component === "phone-input" ? "Phone Input" : component === "radio-button" ? "Radio Button" : component === "switch" ? "Switch" : component === "tag" ? "Tag" : component === "text-area" ? "Text Area" : "Select";
      const factory = component === "badge" ? "createTransitionalBadge" : component === "button" ? "createTransitionalActionButton" : component === "card-expiry-input" ? "createTransitionalPaymentCardExpiryInput" : component === "card-number-input" ? "createTransitionalPaymentCardNumberInput" : component === "card-security-code-input" ? "createTransitionalPaymentCardSecurityCodeInput" : component === "checkbox" ? "createTransitionalChoiceCheckbox" : component === "code-input" ? "createTransitionalSecurityCodeInput" : component === "date-picker" ? "createTransitionalDatePicker" : component === "date-range-picker" ? "createTransitionalDateRangePicker" : component === "icon-button" ? "createTransitionalActionIconButton" : component === "input" ? "createTransitionalFieldInput" : component === "phone-input" ? "createTransitionalPhoneInput" : component === "radio-button" ? "createTransitionalChoiceRadioButton" : component === "switch" ? "createTransitionalChoiceSwitch" : component === "tag" ? "createTransitionalTag" : component === "text-area" ? "createTransitionalFieldTextArea" : "createTransitionalFieldSelect";
