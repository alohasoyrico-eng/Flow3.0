...
const expectedAuditFiles = new Set([
  ...
  "audit-code-block-css-contract.js",
  ...
  "audit-context.js",
  "audit-copy-button-css-contract.js",
  ...
  "report-react-field-message-governance.js",
  "report-anti-duplication-coverage.js",
  "report-component-css-contract-coverage.js",
  "report-component-state-visual-governance.js",
  ...
  "report-system-phase3-foundations-primitives-checkpoint.js",
  "report-system-phase4-component-cascade-checkpoint.js",
  "report-system-phase4-component-qa-checkpoint.js",
  "report-system-phase4-core-controls-checkpoint.js",
  "report-system-phase4-domain-complex-checkpoint.js",
  "report-system-phase4-overlays-navigation-data-checkpoint.js",
  "report-system-phase5-data-domain-mobile-patterns-checkpoint.js",
  "report-system-phase5-interaction-patterns-checkpoint.js",
  ...
  "report-system-phase6-template-qa-checkpoint.js",
  ...
  "report-system-react-source-of-truth.js",
  "report-system-react-build-reproducibility.js",
  "report-system-react-export-parity.js",
  "report-system-react-publication-boundary.js",
  "report-react-production-readiness.js",
  "report-react-pattern-production-readiness.js",
  "report-system-component-artifact-tests.js",
  "report-system-component-runtime-audit.js",
  "report-system-pattern-artifact-tests.js",
  "report-system-pattern-runtime-audit.js",
  "report-system-template-artifact-tests.js",
  "report-system-template-runtime-audit.js",
  "report-system-test-ownership.js",
  "report-system-public-runtime-boundary.js",
  "report-system-phase5-public-runtime-readiness.js",
  "report-system-phase6-flowdocs-consumer-checkpoint.js",
  "report-system-consumer-runtime-smoke.js",
  "report-system-consumer-css-token-cascade.js",
  "report-system-consumer-type-smoke.js",
  "report-system-consumer-boundary-checkpoint.js",
...
const checks = [
  ...
  ["React source of truth", () => run("node", ["packages/audit/scripts/report-system-react-source-of-truth.js", "--check"])],
  ["React build reproducibility", () => run("node", ["packages/audit/scripts/report-system-react-build-reproducibility.js", "--check"])],
  ["React export parity", () => run("node", ["packages/audit/scripts/report-system-react-export-parity.js", "--check"])],
  ["React publication boundary", () => run("node", ["packages/audit/scripts/report-system-react-publication-boundary.js", "--check"])],
  ["React production readiness", () => run("node", ["packages/audit/scripts/report-react-production-readiness.js", "--check"])],
  ["component artifact tests", () => run("node", ["packages/audit/scripts/report-system-component-artifact-tests.js", "--check"])],
  ["component runtime audit", () => run("node", ["packages/audit/scripts/report-system-component-runtime-audit.js", "--check"])],
  ["test ownership report", () => run("node", ["packages/audit/scripts/report-system-test-ownership.js", "--check"])],
  ["consumer runtime smoke", () => run("node", ["packages/audit/scripts/report-system-consumer-runtime-smoke.js", "--check"])],
  ["consumer CSS token cascade", () => run("node", ["packages/audit/scripts/report-system-consumer-css-token-cascade.js", "--check"])],
  ["consumer type smoke", () => run("node", ["packages/audit/scripts/report-system-consumer-type-smoke.js", "--check"])],
  ["consumer boundary checkpoint", () => run("node", ["packages/audit/scripts/report-system-consumer-boundary-checkpoint.js", "--check"])],
  ["public runtime boundary", () => run("node", ["packages/audit/scripts/report-system-public-runtime-boundary.js", "--check"])],
  ["phase 5 public runtime readiness", () => run("node", ["packages/audit/scripts/report-system-phase5-public-runtime-readiness.js", "--check"])],
  ...
  ...(hasDocsConsumerApp ? [["phase 6 FlowDocs consumer checkpoint", () => run("node", ["packages/audit/scripts/report-system-phase6-flowdocs-consumer-checkpoint.js", "--check"])]] : []),
  ...
  ["phase 3 foundations/primitives checkpoint", () => run("node", ["packages/audit/scripts/report-system-phase3-foundations-primitives-checkpoint.js", "--check"])],
  ...
  ["react field message governance report", () => run("node", ["packages/audit/scripts/report-react-field-message-governance.js", "--check"])],
  ...
  ["pattern artifact tests", () => run("node", ["packages/audit/scripts/report-system-pattern-artifact-tests.js", "--check"])],
  ["react pattern production readiness", () => run("node", ["packages/audit/scripts/report-react-pattern-production-readiness.js", "--check"])],
  ["pattern runtime audit", () => run("node", ["packages/audit/scripts/report-system-pattern-runtime-audit.js", "--check"])],
  ...
  ["template artifact tests", () => run("node", ["packages/audit/scripts/report-system-template-artifact-tests.js", "--check"])],
  ["template runtime audit", () => run("node", ["packages/audit/scripts/report-system-template-runtime-audit.js", "--check"])],
  ...(hasZipAuditRoot ? [
  ...
  ["component state visual governance report", () => run("node", ["packages/audit/scripts/report-component-state-visual-governance.js", "--check"])],
  ...
  ["phase 4 component cascade checkpoint", () => run("node", ["packages/audit/scripts/report-system-phase4-component-cascade-checkpoint.js", "--check"])],
  ["phase 4 core controls/forms checkpoint", () => run("node", ["packages/audit/scripts/report-system-phase4-core-controls-checkpoint.js", "--check"])],
  ["phase 4 overlays/navigation/data checkpoint", () => run("node", ["packages/audit/scripts/report-system-phase4-overlays-navigation-data-checkpoint.js", "--check"])],
  ["phase 4 domain/complex checkpoint", () => run("node", ["packages/audit/scripts/report-system-phase4-domain-complex-checkpoint.js", "--check"])],
  ["phase 4 component QA checkpoint", () => run("node", ["packages/audit/scripts/report-system-phase4-component-qa-checkpoint.js", "--check"])],
  ["phase 5 pattern 1:1 checkpoint", () => run("node", ["packages/audit/scripts/report-system-phase5-pattern-1to1-checkpoint.js", "--check"])],
  ["phase 5 shell patterns checkpoint", () => run("node", ["packages/audit/scripts/report-system-phase5-shell-patterns-checkpoint.js", "--check"])],
  ["phase 5 interaction patterns checkpoint", () => run("node", ["packages/audit/scripts/report-system-phase5-interaction-patterns-checkpoint.js", "--check"])],
  ["phase 5 data/domain/mobile patterns checkpoint", () => run("node", ["packages/audit/scripts/report-system-phase5-data-domain-mobile-patterns-checkpoint.js", "--check"])],
  ["phase 5 pattern governance checkpoint", () => run("node", ["packages/audit/scripts/report-system-phase5-pattern-governance-checkpoint.js", "--check"])],
