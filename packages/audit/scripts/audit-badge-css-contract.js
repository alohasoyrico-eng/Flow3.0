...
function checkBadgeCssContract({ text, blocks, packageCssFile, selectorKey }) {
  ...
  requireIncludes({
    ...
    snippets: [
      ...
      "--comp-badge-min-block-size-sm: var(--component-space-xl)",
      "--comp-badge-min-block-size-md: var(--component-badge-min-size)",
      "--comp-badge-min-block-size-lg: var(--component-control-frame-size-sm)",
      "--comp-badge-min-block-size: var(--comp-badge-min-block-size-md)",
      ...
      "min-block-size: var(--comp-badge-min-block-size)",
  ...
  requireIncludes({
    ...
    text,
    packageCssFile,
    snippets: ["--comp-badge-font-size: var(--comp-badge-font-size-sm)", "--comp-badge-icon-size: var(--component-density-icon-size-sm)", "--comp-badge-min-block-size: var(--comp-badge-min-block-size-sm)"],
    message: "Badge sm density must scale compact voice, icon, and frame through shared density aliases.",
  });
  requireIncludes({
    block: lgBlock,
    text,
    packageCssFile,
    snippets: ["--comp-badge-font-size: var(--comp-badge-font-size-lg)", "--comp-badge-icon-size: var(--component-density-icon-size-lg)", "--comp-badge-min-block-size: var(--comp-badge-min-block-size-lg)"],
    message: "Badge lg density must scale compact voice, icon, and frame through shared density aliases.",
  });
  requireIncludes({
    block: hoverBlock,
    text,
