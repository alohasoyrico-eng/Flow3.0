...
const componentRoles = {
  ...
  "code-block": { role: "content", status: "not-applicable", iteration: null, note: "Code content surface; copy affordance composes Button and owns no duplicate action frame." },
