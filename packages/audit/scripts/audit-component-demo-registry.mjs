...
for (const componentId of componentIds) {
  ...
  const expectedSource = new Set(["badge", "button", "card-expiry-input", "card-number-input", "card-security-code-input", "checkbox", "code-input", "date-picker", "date-range-picker", "icon-button", "input", "phone-input", "radio-button", "select", "switch", "tag", "text-area"]).has(componentId) ? 'data-component-source="react"' : 'data-component-source="package"';
