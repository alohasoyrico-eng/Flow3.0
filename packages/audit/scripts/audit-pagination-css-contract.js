...
function checkPaginationCssContract({ text, blocks, packageCssFile, selectorKey, root }) {
  ...
  requireIncludes({
    ...
    snippets: [
      ...
      "--comp-pagination-size-sm: var(--component-control-frame-size-sm)",
  ...
  for (const [block, snippets, message] of [
    ...
    requireIncludes({
      ...
      text,
      packageCssFile,
      snippets: [...snippets, "--comp-pagination-gap:"],
      message,
    });
  }
}
