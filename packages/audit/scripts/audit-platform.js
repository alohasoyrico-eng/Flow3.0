...
function checkReleaseAndAdoption() {
  ...
  for (const [file, requiredSnippets] of [
    ...
    [componentSmokeTestFile, ["componentContracts", "createTransitionalActionButton", "createTransitionalActionIconButton", "createTransitionalFieldInput", "createTransitionalFieldSelect", "components smoke tests passed"]],
  ]) {
