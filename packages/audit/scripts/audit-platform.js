...
function checkPrototypePackages() {
  ...
  for (const [label, hydrator] of [["Card Security Code Input", "hydrateTransitionalPaymentCardSecurityCodeInput"], ["Code Input", "hydrateTransitionalSecurityCodeInput"], ["Date Picker", "hydrateTransitionalDatePicker"], ["Date Range Picker", "hydrateTransitionalDateRangePicker"], ["Phone Input", "hydrateTransitionalPhoneInput"]]) {
