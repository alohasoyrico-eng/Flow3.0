...
function checkReleaseAndAdoption() {
  ...
  for (const [file, requiredSnippets] of [
    ...
    [componentSmokeTestFile, ["componentContracts", "createTransitionalActionButton", "createTransitionalActionIconButton", "createTransitionalChoiceCheckbox", "createTransitionalFieldInput", "createTransitionalFieldSelect", "createTransitionalFieldTextArea", "createCard", "components smoke tests passed"]],
  ]) {
