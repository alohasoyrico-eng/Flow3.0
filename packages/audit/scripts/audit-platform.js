...
function checkPrototypePackages() {
  ...
  for (const [label, factory] of [["Button", "createButton"], ["Checkbox", "createTransitionalChoiceCheckbox"], ["Icon Button", "createIconButton"], ["Input", "createTransitionalFieldInput"], ["Radio Button", "createTransitionalChoiceRadioButton"], ["Select", "createTransitionalFieldSelect"], ["Switch", "createSwitch"], ["Text Area", "createTransitionalFieldTextArea"]]) {
  ...
  for (const [label, target, internalFactory] of [["Checkbox", "checkbox", "createTransitionalChoiceCheckbox"], ["Input", "input", "createTransitionalFieldInput"], ["Radio Button", "radio-button", "createTransitionalChoiceRadioButton"], ["Select", "select", "createTransitionalFieldSelect"], ["Text Area", "text-area", "createTransitionalFieldTextArea"]]) {
