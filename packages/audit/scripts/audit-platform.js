...
function checkArchitectureGate() {
  ...
  const requiredPaths = [
    ...
    "packages/components/src/platforms/index.js", "packages/components/src/platforms/button.js", "packages/components/src/platforms/card-expiry-input.js", "packages/components/src/platforms/card-number-input.js", "packages/components/src/platforms/card-security-code-input.js",
...
function checkPrototypePackages() {
  ...
  for (const [label, hydrator] of [["Card Expiry Input", "hydrateTransitionalPaymentCardExpiryInput"], ["Card Number Input", "hydrateTransitionalPaymentCardNumberInput"], ["Card Security Code Input", "hydrateTransitionalPaymentCardSecurityCodeInput"], ["Input", "hydrateInput"], ["Select", "hydrateSelect"], ["Text Area", "hydrateTransitionalTextArea"]]) {
