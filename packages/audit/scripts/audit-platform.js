...
function checkPrototypePackages() {
  ...
  for (const [label, target, internalFactory] of [["Date Range Picker", "date-range-picker", "createTransitionalDateRangePicker"]]) {
  ...
  for (const [label, hydrator] of [["Date Range Picker", "hydrateTransitionalDateRangePicker"]]) {
