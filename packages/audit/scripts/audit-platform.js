...
function checkPrototypePackages() {
  ...
  for (const [label, target, internalFactory] of [["Button", "button", "createTransitionalActionButton"], ["Card Expiry Input", "card-expiry-input", "createTransitionalPaymentCardExpiryInput"], ["Card Number Input", "card-number-input", "createTransitionalPaymentCardNumberInput"], ["Card Security Code Input", "card-security-code-input", "createTransitionalPaymentCardSecurityCodeInput"], ["Code Input", "code-input", "createTransitionalSecurityCodeInput"], ["Date Picker", "date-picker", "createTransitionalDatePicker"], ["Date Range Picker", "date-range-picker", "createTransitionalDateRangePicker"], ["Icon Button", "icon-button", "createTransitionalActionIconButton"], ["Input", "input", "createTransitionalFieldInput"], ["Phone Input", "phone-input", "createTransitionalPhoneInput"], ["Radio Button", "radio-button", "createTransitionalChoiceRadioButton"], ["Select", "select", "createTransitionalFieldSelect"], ["Text Area", "text-area", "createTransitionalFieldTextArea"]]) {
...
function checkReleaseAndAdoption() {
  ...
  for (const [file, requiredSnippets] of [
    ...
    [componentSmokeTestFile, ["componentContracts", "createTransitionalActionButton", "createTransitionalActionIconButton", "createTransitionalFieldInput", "createTransitionalFieldSelect", "createTransitionalFieldTextArea", "components smoke tests passed"]],
  ]) {
