...
function checkPrototypePackages() {
  ...
  for (const [label, target, factory] of [["Card", "card", "createCard"], ["Table", "table", "createTable"], ["List", "list", "createList"], ["KPI Tile", "kpi-tile", "createKpiTile"], ["Audit Event", "audit-event", "createAuditEvent"], ["Chart Panel", "chart-panel", "createChartPanel"], ["Station Pin", "station-pin", "createStationPin"]]) {
