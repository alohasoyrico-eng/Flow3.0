...
function checkArchitectureGate() {
  ...
  const requiredPaths = [
    ...
    "packages/components/src/platforms/index.js", "packages/components/src/platforms/animated-moment.js", "packages/components/src/platforms/audit-event.js", "packages/components/src/platforms/biometric-prompt.js", "packages/components/src/platforms/button.js", "packages/components/src/platforms/card-expiry-input.js", "packages/components/src/platforms/card-number-input.js", "packages/components/src/platforms/card-security-code-input.js", "packages/components/src/platforms/card-summary.js", "packages/components/src/platforms/chart-panel.js", "packages/components/src/platforms/code-input.js", "packages/components/src/platforms/country-selector.js", "packages/components/src/platforms/floating-action-button.js", "packages/components/src/platforms/motion-boundary.js", "packages/components/src/platforms/movement-row.js", "packages/components/src/platforms/quick-action.js", "packages/components/src/platforms/route-summary.js", "packages/components/src/platforms/station-pin.js", "packages/components/src/platforms/tree-view.js",
    "packages/react/package.json", "packages/react/src/index.js", "packages/react/src/AnimatedMoment.js", "packages/react/src/AuditEvent.js", "packages/react/src/BiometricPrompt.js", "packages/react/src/Button.js", "packages/react/src/CardSummary.js", "packages/react/src/ChartPanel.js", "packages/react/src/CountrySelector.js", "packages/react/src/FloatingActionButton.js", "packages/react/src/MotionBoundary.js", "packages/react/src/MovementRow.js", "packages/react/src/QuickAction.js", "packages/react/src/RouteSummary.js", "packages/react/src/StationPin.js", "packages/react/src/TreeView.js",
...
function checkPrototypePackages() {
  ...
  for (const [label, factory] of [["Avatar", "createTransitionalAvatar"], ["Badge", "createTransitionalBadge"], ["Button", "createTransitionalActionButton"], ["Card", "createCard"], ["Card Expiry Input", "createTransitionalPaymentCardExpiryInput"], ["Card Number Input", "createTransitionalPaymentCardNumberInput"], ["Card Security Code Input", "createTransitionalPaymentCardSecurityCodeInput"], ["Checkbox", "createTransitionalChoiceCheckbox"], ["Chip", "createTransitionalChip"], ["Code Input", "createTransitionalSecurityCodeInput"], ["Date Picker", "createTransitionalDatePicker"], ["Date Range Picker", "createTransitionalDateRangePicker"], ["Floating Action Button", "createFloatingActionButton"], ["Icon Button", "createTransitionalActionIconButton"], ["Input", "createTransitionalFieldInput"], ["KPI Tile", "createKpiTile"], ["List", "createList"], ["Menu", "createMenu"], ["Phone Input", "createTransitionalPhoneInput"], ["Radio Button", "createTransitionalChoiceRadioButton"], ["Select", "createTransitionalFieldSelect"], ["Switch", "createTransitionalChoiceSwitch"], ["Table", "createTable"], ["Tag", "createTransitionalTag"], ["Text Area", "createTransitionalFieldTextArea"], ["Tree View", "createTreeView"]]) {
  ...
  for (const [label, target, internalFactory] of [["Avatar", "avatar", "createTransitionalAvatar"], ["Badge", "badge", "createTransitionalBadge"], ["Button", "button", "createTransitionalActionButton"], ["Card Expiry Input", "card-expiry-input", "createTransitionalPaymentCardExpiryInput"], ["Card Number Input", "card-number-input", "createTransitionalPaymentCardNumberInput"], ["Card Security Code Input", "card-security-code-input", "createTransitionalPaymentCardSecurityCodeInput"], ["Checkbox", "checkbox", "createTransitionalChoiceCheckbox"], ["Chip", "chip", "createTransitionalChip"], ["Code Input", "code-input", "createTransitionalSecurityCodeInput"], ["Date Picker", "date-picker", "createTransitionalDatePicker"], ["Date Range Picker", "date-range-picker", "createTransitionalDateRangePicker"], ["Floating Action Button", "floating-action-button", "createFloatingActionButton"], ["Icon Button", "icon-button", "createTransitionalActionIconButton"], ["Input", "input", "createTransitionalFieldInput"], ["Menu", "menu", "createMenu"], ["Phone Input", "phone-input", "createTransitionalPhoneInput"], ["Radio Button", "radio-button", "createTransitionalChoiceRadioButton"], ["Select", "select", "createTransitionalFieldSelect"], ["Switch", "switch", "createTransitionalChoiceSwitch"], ["Tag", "tag", "createTransitionalTag"], ["Text Area", "text-area", "createTransitionalFieldTextArea"], ["Tree View", "tree-view", "createTreeView"]]) {
  ...
  if (!componentContractText.includes('factory: "@design-system/react/card"')) add("errors", componentContracts, 1, "Card contract must expose the React package target.");
  if (componentContractText.includes('internalFactory: "createCard"')) add("errors", componentContracts, 1, "Card must not keep a DOM internalFactory; React is the single product component implementation.");
  if (!componentContractText.includes('factory: "@design-system/react/table"')) add("errors", componentContracts, 1, "Table contract must expose the React package target.");
  if (componentContractText.includes('internalFactory: "createTable"')) add("errors", componentContracts, 1, "Table must not keep a DOM internalFactory; React is the single product component implementation.");
  if (!componentContractText.includes('factory: "@design-system/react/list"')) add("errors", componentContracts, 1, "List contract must expose the React package target.");
  if (componentContractText.includes('internalFactory: "createList"')) add("errors", componentContracts, 1, "List must not keep a DOM internalFactory; React is the single product component implementation.");
  if (!componentContractText.includes('factory: "@design-system/react/kpi-tile"')) add("errors", componentContracts, 1, "KPI Tile contract must expose the React package target.");
  if (componentContractText.includes('internalFactory: "createKpiTile"')) add("errors", componentContracts, 1, "KPI Tile must not keep a DOM internalFactory; React is the single product component implementation.");
  for (const [label, hydrator] of [["Card Expiry Input", "hydrateTransitionalPaymentCardExpiryInput"], ["Card Number Input", "hydrateTransitionalPaymentCardNumberInput"], ["Card Security Code Input", "hydrateTransitionalPaymentCardSecurityCodeInput"], ["Code Input", "hydrateTransitionalSecurityCodeInput"], ["Date Picker", "hydrateTransitionalDatePicker"], ["Date Range Picker", "hydrateTransitionalDateRangePicker"], ["Input", "hydrateInput"], ["Phone Input", "hydrateTransitionalPhoneInput"], ["Select", "hydrateSelect"], ["Text Area", "hydrateTransitionalTextArea"]]) {
  ...
  for (const exampleFile of exampleFiles) {
    ...
    if (exampleFile.endsWith("index.html")) {
      ...
      if (exampleText.includes("createCard")) add("errors", exampleFile, 1, "Basic prototype must consume the React Card instead of the internal DOM card factory.");
      if (!exampleText.includes("packages/react/dist/Card.js") || !exampleText.includes("React.createElement(Card")) add("errors", exampleFile, 1, "Basic prototype must consume the React Card product component.");
      ...
      if (exampleText.includes("createCard")) add("errors", exampleFile, 1, "Fleet dashboard prototype must consume the React Card instead of the internal DOM card factory.");
      if (!exampleText.includes("packages/react/dist/Card.js") || !exampleText.includes("React.createElement(Card")) add("errors", exampleFile, 1, "Fleet dashboard prototype must consume the React Card product component.");
...
function checkReleaseAndAdoption() {
  ...
  for (const [file, requiredSnippets] of [
    ...
    [componentSmokeTestFile, ["componentContracts", "createTransitionalActionButton", "createTransitionalActionIconButton", "createTransitionalChoiceCheckbox", "createTransitionalFieldInput", "createTransitionalFieldSelect", "createTransitionalFieldTextArea", "components smoke tests passed"]],
  ]) {
