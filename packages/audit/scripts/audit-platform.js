...
function checkPrototypePackages() {
  ...
  for (const [label, hydrator] of [["Card Expiry Input", "hydrateTransitionalPaymentCardExpiryInput"], ["Card Number Input", "hydrateTransitionalPaymentCardNumberInput"], ["Card Security Code Input", "hydrateTransitionalPaymentCardSecurityCodeInput"], ["Code Input", "hydrateTransitionalSecurityCodeInput"], ["Date Picker", "hydrateTransitionalDatePicker"], ["Date Range Picker", "hydrateTransitionalDateRangePicker"], ["Phone Input", "hydrateTransitionalPhoneInput"], ["Select", "hydrateSelect"]]) {
...
function checkReleaseAndAdoption() {
  ...
  for (const [file, requiredSnippets] of [
    ...
    [componentSmokeTestFile, ["componentContracts", "createTransitionalActionButton", "createTransitionalActionIconButton", "createTransitionalFieldSelect", "components smoke tests passed"]],
  ]) {
