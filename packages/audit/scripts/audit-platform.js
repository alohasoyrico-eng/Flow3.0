...
function checkPrototypePackages() {
  ...
  for (const [label, target, internalFactory] of [["Code Input", "code-input", "createTransitionalSecurityCodeInput"], ["Date Picker", "date-picker", "createTransitionalDatePicker"], ["Date Range Picker", "date-range-picker", "createTransitionalDateRangePicker"], ["Phone Input", "phone-input", "createTransitionalPhoneInput"]]) {
  ...
  for (const [label, hydrator] of [["Code Input", "hydrateTransitionalSecurityCodeInput"], ["Date Picker", "hydrateTransitionalDatePicker"], ["Date Range Picker", "hydrateTransitionalDateRangePicker"], ["Phone Input", "hydrateTransitionalPhoneInput"]]) {
