...
function checkPrototypePackages() {
  ...
  for (const [label, factory] of [["Button", "createButton"], ["Checkbox", "createCheckbox"], ["Icon Button", "createIconButton"], ["Input", "createTransitionalFieldInput"], ["Radio Button", "createRadioButton"], ["Select", "createTransitionalFieldSelect"], ["Switch", "createSwitch"], ["Text Area", "createTransitionalFieldTextArea"]]) {
  ...
  for (const [label, target, internalFactory] of [["Input", "input", "createTransitionalFieldInput"], ["Select", "select", "createTransitionalFieldSelect"], ["Text Area", "text-area", "createTransitionalFieldTextArea"]]) {
...
function checkReleaseAndAdoption() {
  ...
  for (const [file, requiredSnippets] of [
    ...
    [componentSmokeTestFile, ["componentContracts", "createButton", "createIconButton", "createTransitionalFieldInput", "createTransitionalFieldSelect", "createTransitionalFieldTextArea", "createCard", "components smoke tests passed"]],
  ]) {
