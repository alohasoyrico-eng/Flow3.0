...
function checkPrototypePackages() {
  ...
  for (const [label, target, internalFactory] of [["Card Expiry Input", "card-expiry-input", "createTransitionalPaymentCardExpiryInput"], ["Card Number Input", "card-number-input", "createTransitionalPaymentCardNumberInput"], ["Card Security Code Input", "card-security-code-input", "createTransitionalPaymentCardSecurityCodeInput"], ["Code Input", "code-input", "createTransitionalSecurityCodeInput"], ["Date Picker", "date-picker", "createTransitionalDatePicker"], ["Date Range Picker", "date-range-picker", "createTransitionalDateRangePicker"], ["Phone Input", "phone-input", "createTransitionalPhoneInput"]]) {
