...
function checkReleaseAndAdoption() {
  ...
  for (const [file, requiredSnippets] of [
    ...
    [componentSmokeTestFile, ["componentContracts", "createTransitionalActionIconButton", "components smoke tests passed"]],
  ]) {
