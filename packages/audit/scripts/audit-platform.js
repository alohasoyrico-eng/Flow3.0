...
function checkPrototypePackages() {
  ...
  for (const [label, target, internalFactory] of [["Date Picker", "date-picker", "createTransitionalDatePicker"], ["Date Range Picker", "date-range-picker", "createTransitionalDateRangePicker"]]) {
  ...
  for (const [label, hydrator] of [["Date Picker", "hydrateTransitionalDatePicker"], ["Date Range Picker", "hydrateTransitionalDateRangePicker"]]) {
