...
function checkGoldComponentTokens() {
  ...
  const badgeChipTabsVisualContract = [
    ...
    ["--comp-tabs-bg: var(--component-energy-surface-sunken)", "Tabs default variant must use a sunken pill group surface."],
    ["--comp-tabs-tab-bg-selected: var(--component-energy-surface-primary)", "Tabs selected state must use raised surface treatment, not a filled action button."],
    ...
    ["--comp-toast-shadow: var(--component-depth-elevation-3)", "Toast must use Depth as a floating feedback layer."],
    ...
    ["--comp-inline-validation-danger: var(--component-energy-status-error)", "Inline Validation error state must use Design System Energy danger semantics."],
  ...
  const packageSemanticChecks = [
    ...
    [["<progress", "createElement(\"progress\"", "document.createElement(\"progress\")"], "Progress Indicator demos must expose native progressbar semantics and determinate values."],
    [["value=\"", ".value =", "setAttribute(\"value\""], "Progress Indicator demos must expose native progressbar semantics and determinate values."],
