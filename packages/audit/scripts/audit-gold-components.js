...
function checkGoldComponentTokens() {
  ...
  const badgeChipTabsVisualContract = [
    ...
    ["--progress-tone: var(--component-loading-progress-fill)", "Progress Indicator active fill must use Design System action primary through the Loading primitive bridge."],
    ["inline-size var(--component-duration-slow) var(--progress-motion-ease)", "Progress Indicator determinate motion must follow the ZIP timing through package Momentum aliases."],
