...
function checkStepperCssContract({ text, blocks, packageCssFile, selectorKey }) {
  ...
  requireIncludes({
    ...
    snippets: [
      ...
      "--comp-stepper-marker-font-size-sm: var(--component-density-helper-size-sm)",
      "--comp-stepper-marker-font-size-md: var(--component-density-helper-size-md)",
      "--comp-stepper-marker-font-size-lg: var(--component-density-helper-size-lg)",
      "--comp-stepper-marker-font-size: var(--comp-stepper-marker-font-size-md)",
      "--comp-stepper-marker-complete-font-size-sm: var(--component-density-icon-size-sm)",
      "--comp-stepper-marker-complete-font-size-md: var(--component-density-icon-size-md)",
      "--comp-stepper-marker-complete-font-size-lg: var(--component-density-icon-size-lg)",
      "--comp-stepper-marker-complete-font-size: var(--comp-stepper-marker-complete-font-size-md)",
      "--comp-stepper-label-size-sm: var(--component-density-label-size-sm)",
      "--comp-stepper-label-size-md: var(--component-density-label-size-md)",
      "--comp-stepper-label-size-lg: var(--component-density-label-size-lg)",
      "--comp-stepper-label-size: var(--comp-stepper-label-size-md)",
      "--comp-stepper-description-size-sm: var(--component-density-helper-size-sm)",
      "--comp-stepper-description-size-md: var(--component-density-helper-size-md)",
      "--comp-stepper-description-size-lg: var(--component-density-helper-size-lg)",
      "--comp-stepper-description-size: var(--comp-stepper-description-size-md)",
  ...
  requireIncludes({
    ...
    snippets: [
      ...
      "font-size: var(--comp-stepper-marker-font-size)",
  ...
  requireIncludes({
    ...
    snippets: [
      ...
      "font-size: var(--comp-stepper-marker-complete-font-size)",
    ],
  ...
  requireIncludes({
    ...
    packageCssFile,
    snippets: [
      "font-size: var(--comp-stepper-label-size)",
      "gap: var(--comp-stepper-text-gap)",
      "max-inline-size: var(--comp-stepper-text-max-inline)",
      "min-inline-size: var(--comp-stepper-text-min-inline)",
    ],
  ...
  requireIncludes({
    ...
    packageCssFile,
    snippets: [
      "--comp-stepper-marker-size: var(--component-step-marker-size-sm)",
      "--comp-stepper-marker-font-size: var(--comp-stepper-marker-font-size-sm)",
      "--comp-stepper-marker-complete-font-size: var(--comp-stepper-marker-complete-font-size-sm)",
      "--comp-stepper-label-size: var(--comp-stepper-label-size-sm)",
      "--comp-stepper-description-size: var(--comp-stepper-description-size-sm)",
    ],
  ...
  requireIncludes({
    ...
    packageCssFile,
    snippets: [
      "--comp-stepper-marker-size: var(--component-step-marker-size-lg)",
      "--comp-stepper-marker-font-size: var(--comp-stepper-marker-font-size-lg)",
      "--comp-stepper-marker-complete-font-size: var(--comp-stepper-marker-complete-font-size-lg)",
      "--comp-stepper-label-size: var(--comp-stepper-label-size-lg)",
      "--comp-stepper-description-size: var(--comp-stepper-description-size-lg)",
      "--comp-stepper-current-scale: var(--component-scale-hover)",
    ],
