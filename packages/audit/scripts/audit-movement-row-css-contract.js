...
function checkMovementRowCssContract({ text, blocks, packageCssFile, selectorKey }) {
  ...
  for (const snippet of [
    ...
    "--comp-movement-row-icon-font-size-sm: var(--component-density-icon-size-sm)",
    "--comp-movement-row-icon-font-size-md: var(--component-density-icon-size-md)",
    "--comp-movement-row-icon-font-size-lg: var(--component-density-icon-size-lg)",
    "--comp-movement-row-title-size-sm: var(--component-density-label-size-sm)",
    "--comp-movement-row-title-size-md: var(--component-density-label-size-md)",
    "--comp-movement-row-title-size-lg: var(--component-density-label-size-lg)",
    "--comp-movement-row-caption-size-sm: var(--component-density-helper-size-sm)",
    "--comp-movement-row-caption-size-md: var(--component-density-helper-size-md)",
    "--comp-movement-row-caption-size-lg: var(--component-density-helper-size-lg)",
    "--comp-movement-row-amount-size-sm: var(--component-density-value-size-sm)",
    "--comp-movement-row-amount-size-md: var(--component-density-value-size-md)",
    "--comp-movement-row-amount-size-lg: var(--component-density-value-size-lg)",
    "--comp-movement-row-status-size-sm: var(--component-density-helper-size-sm)",
    "--comp-movement-row-status-size-md: var(--component-density-helper-size-md)",
    "--comp-movement-row-status-size-lg: var(--component-density-helper-size-lg)",
  ]) {
  ...
  requireIncludes({
    ...
    packageCssFile,
    snippets: [
      "--comp-movement-row-amount-size: var(--comp-movement-row-amount-size-sm)",
      "--comp-movement-row-caption-size: var(--comp-movement-row-caption-size-sm)",
      ...
      "--comp-movement-row-icon-font-size: var(--comp-movement-row-icon-font-size-sm)",
      "--comp-movement-row-status-size: var(--comp-movement-row-status-size-sm)",
      "--comp-movement-row-title-size: var(--comp-movement-row-title-size-sm)",
    ],
  ...
  requireIncludes({
    ...
    packageCssFile,
    snippets: [
      "--comp-movement-row-amount-size: var(--comp-movement-row-amount-size-lg)",
      "--comp-movement-row-caption-size: var(--comp-movement-row-caption-size-lg)",
      ...
      "--comp-movement-row-icon-font-size: var(--comp-movement-row-icon-font-size-lg)",
      "--comp-movement-row-status-size: var(--comp-movement-row-status-size-lg)",
      "--comp-movement-row-title-size: var(--comp-movement-row-title-size-lg)",
    ],
  ...
  requireIncludes({
    ...
    snippets: [
      ...
      "font-size: var(--comp-movement-row-icon-font-size)",
