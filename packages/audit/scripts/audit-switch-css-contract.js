...
function checkSwitchCssContract({ text, blocks, packageCssFile, selectorKey, root }) {
  ...
  for (const [block, snippets, message] of [
    ...
    [trackBlock, ["background: var(--comp-switch-current-track-bg)", "box-sizing: border-box", "inline-size: var(--comp-switch-current-track-width)", "min-block-size: var(--comp-switch-current-track-block)", "padding: var(--comp-switch-current-track-padding)", "pointer-events: none"], "Switch track must consume current geometry/state aliases and avoid intercepting native input interaction."],
    [thumbBlock, ["background: var(--comp-switch-current-thumb-bg)", "block-size: var(--comp-switch-current-thumb-size)", "box-sizing: border-box", "inline-size: var(--comp-switch-current-thumb-size)", "pointer-events: none"], "Switch thumb must consume current geometry aliases and avoid intercepting native input interaction."],
