...
function checkPlatformAdapters() {
  for (const file of [adapterIndexFile, buttonAdapterFile, iconButtonAdapterFile, inputAdapterFile, selectAdapterFile, reactButtonFile, reactButtonTypesFile, reactIconButtonFile, reactIconButtonTypesFile, reactInputFile, reactInputTypesFile, reactSelectFile, reactSelectTypesFile, reactIndexFile, reactIndexTypesFile, reactDistButtonFile, reactDistButtonTypesFile, reactDistIconButtonFile, reactDistIconButtonTypesFile, reactDistInputFile, reactDistInputTypesFile, reactDistSelectFile, reactDistSelectTypesFile, reactPackageFile, reactExampleFile]) {
  ...
  for (const [file, source, required] of [
    ...
    [reactPackageFile, reactPackage, ['"build": "node scripts/build.mjs"', '"test": "node test/button-render.test.mjs"', '"types": "./dist/index.d.ts"', '"./button"', '"./select"']],
    ...
    [reactIndexFile, reactIndex, ["Button", "IconButton", "Input", "Select"]],
    [reactIndexTypesFile, reactIndexTypes, ["ButtonProps", "IconButtonProps", "InputProps", "SelectProps"]],
  ]) {
