...
const semanticAriaDefaultsByFile = new Map([
  ...
  ["CardExpiryInput.js", ["Expiry date", "Loading", " loading", "MM/YY"]],
  ...
  ["DateRangePicker.js", ["Date range picker", "Date range calendar", "Start date", "End date", "start date", "end date", "Previous month", "Next month"]],
...
const visibleTriggerDefaultsByFile = new Map([
  ...
  ["Menu.js", ["Actions", "Menu", "Open menu", "Account menu", "Edit", "Duplicate", "Delete", "Archive"]],
  ["Popover.js", ["Open popover", "Popover", "Open"]],
