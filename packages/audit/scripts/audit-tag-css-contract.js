...
function checkTagCssContract({ text, blocks, packageCssFile, selectorKey }) {
  ...
  requireIncludes({
    ...
    snippets: [
      ...
      "--comp-tag-interactive-min-block-size-md: var(--component-inline-trigger-min-block-size-md)",
      "--comp-tag-interactive-min-block-size: var(--comp-tag-interactive-min-block-size-md)",
