...
function checkControlFrameCssContract() {
  ...
  const required = [
    ...
    ["--component-control-frame-radius-field-sm: var(--component-radius-md);", "Field controls must expose a small density radius role."],
    ["--component-control-frame-radius-field-md: var(--component-radius-control);", "Field controls must expose a medium density radius role."],
    ["--component-control-frame-radius-field-lg: var(--component-radius-card);", "Field controls must expose a large density radius role."],
    ["--component-control-frame-radius-field: var(--component-control-frame-radius-field-md);", "Field controls must default to the medium density radius role."],
    ...
    ["--component-control-frame-radius-field: var(--component-control-frame-radius-field-sm);", "Field sm density must consume the small field radius role."],
    ["--component-control-frame-radius-field: var(--component-control-frame-radius-field-lg);", "Field lg density must consume the large field radius role."],
