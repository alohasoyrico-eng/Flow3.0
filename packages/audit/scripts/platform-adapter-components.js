const components = [
  ...
  },
  {
    ...
    props: ["label", "value", "message", "state", "id", "fullWidth", "field", "fieldAriaLabel", "live"],
    ...
    typeSnippets: ["ForwardRefExoticComponent", "RefAttributes<HTMLDivElement>", "InlineValidationProps", "InlineValidationState", "fieldAriaLabel?: string", "inlineValidationPlatformContract"],
