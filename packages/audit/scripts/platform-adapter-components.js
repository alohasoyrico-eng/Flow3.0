const components = [
  ...
  },
  {
    ...
    jsSnippets: ["motionBoundaryPlatformContract", "className: [\"motion-boundary\"", 'flowVariantProps(resolvedVariant)', 'flowStateProps(resolvedState)', '"data-reduced-motion": String(isReducedMotion)', "role: \"group\"", '"aria-labelledby": `${id}-label`', "motion-boundary__icon", "motion-boundary__content", "motion-boundary__state", "motion-boundary__cue"],
  ...
  },
  {
    ...
    jsSnippets: ["codeInputPlatformContract", "className: [\"field code-input\"", 'flowDensityProps(density)', 'flowVariantProps(resolvedVariant)', '"data-focused": focused ? "true" : "false"', '"data-length": String(resolvedLength)', "normalizeCodeValue", "resolveCodeInputState", "code-input__control", "code-input__slots", "code-input__slot", "onComplete"],
  ...
  },
  {
    ...
    jsSnippets: ["buttonPlatformContract", "className: buttonClassName", 'flowDensityProps(density)', 'flowStateProps(resolvedState)', "button__label", "React.createElement(Spinner", "decorative: true"],
  ...
  },
  {
    ...
    jsSnippets: ["movementRowPlatformContract", "className: [\"movement-row\"", 'flowVariantProps(resolvedVariant)', 'flowStateProps(resolvedState)', 'flowDensityProps(resolvedDensity)', '"data-category": resolvedCategory', '"data-full-width": String(Boolean(fullWidth))', "movement-row__icon", "movement-row__content", "movement-row__value", "onSelect"],
  ...
  },
  {
    ...
    jsSnippets: ["breadcrumbsPlatformContract", "className: [\"breadcrumbs\"", '"aria-label": label', 'flowVariantProps(resolvedVariant)', 'flowStateProps(resolvedState)', 'flowDensityProps(density)', "breadcrumbs__item", "breadcrumbs__target", "breadcrumbs__target--collapsed", "breadcrumbs__separator", "aria-current"],
  ...
  },
  {
    ...
    jsSnippets: ["paginationPlatformContract", "className: [\"pagination\"", '"aria-label": label', 'flowVariantProps(resolvedVariant)', 'flowStateProps(resolvedState)', 'flowDensityProps(density)', '"data-page": String(currentPage)', '"data-page-count": String(totalPages)', "pagination__button", "pagination__icon", "pagination__ellipsis", "aria-current", "onPageChange"],
  ...
  },
  {
    ...
    jsSnippets: ["checkboxPlatformContract", "className: [\"choice checkbox\"", 'flowDensityProps(density)', 'flowStateProps(normalizedState)', "choice__input", "choice__mark", "choice__indicator", "onCheckedChange"],
  ...
  },
  {
    ...
    jsSnippets: ["inputPlatformContract", "className: [\"field\"", 'flowDensityProps(density)', 'flowStateProps(resolvedState)', "field__control", "field__helper", "field-action", "normalizeValue", "inputModeForVariant"],
  ...
  },
  {
    ...
    primitives: ["color", "typography", "spacing", "radius", "focus", "disabled", "duration", "motion-curves", "message", "measurement"],
    props: [],
    jsSnippets: ["radioButtonPlatformContract", "className: [\"choice radio\"", 'flowDensityProps(density)', 'flowStateProps(normalizedState)', "choice__input", "choice__mark", "onCheckedChange"],
  ...
  },
  {
    ...
    jsSnippets: ["segmentedControlPlatformContract", "className: [\"segmented-control\"", 'flowDensityProps(density)', 'flowVariantProps(resolvedVariant)', "role: \"tablist\"", "segmented-control__indicator", "segmented-control__item", "segmented-control__icon", "segmented-control__label", "onValueChange", "ArrowRight", "ArrowLeft", "Home", "End"],
  ...
  },
  {
    ...
    jsSnippets: ["spinnerPlatformContract", "className: [\"spinner\"", 'flowDensityProps(normalizeFlowDensity(density))', 'flowToneProps(normalizeTone(tone))', 'flowStateProps(resolvedState)', "role: isDecorative ? undefined : \"status\"", "spinner__svg", "spinner__track", "spinner__arc"],
  ...
  },
  {
    ...
    primitives: ["color", "typography", "spacing", "radius", "focus", "disabled", "duration", "motion-curves", "message", "measurement"],
    props: [],
    jsSnippets: ["switchPlatformContract", "className: [\"switch\"", 'flowDensityProps(density)', 'flowStateProps(normalizedState)', "switch__input", "switch__track", "switch__thumb", "onCheckedChange"],
