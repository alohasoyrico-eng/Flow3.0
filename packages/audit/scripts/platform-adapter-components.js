const components = [
  {
    ...
    jsSnippets: ["accordionPlatformContract", "className: [\"accordion\"", '"data-variant": resolvedVariant', '"data-multiple": String(allowsMultiple)', '"data-density": resolvedDensity', '"data-accordion-trigger": ""', '"aria-expanded": String(open)', '"aria-controls": panelId', "accordion__icon", "accordion__title", "accordion__meta", "accordion__chevron", "accordion__panel", "onExpandedChange"],
