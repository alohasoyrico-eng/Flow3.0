const components = [
  ...
  },
  {
    ...
    jsSnippets: ["animatedMomentPlatformContract", "className: [\"animated-moment\"", 'flowVariantProps(resolvedVariant)', 'flowStateProps(resolvedState)', 'flowDensityProps(resolvedDensity)', "normalizeFlowDensity(density)", '"data-full-width": String(Boolean(fullWidth))', "animation-asset animated-moment__asset", '"data-animation-library": "lottie-web"', "animated-moment__stage", "animated-moment__state", "animated-moment__cue"],
  ...
  },
  {
    id: "copy-button",
    label: "Copy Button",
    contractKey: "copyButton",
    className: "copy-button",
    files: ["CopyButton.js", "CopyButton.d.ts"],
    exports: ["copyButtonPlatformAdapters", "copyButtonPlatformContract", "copyButtonPlatformProps"],
    requiredTokens: ["comp.copy-button.*", "comp.button.*", "comp.icon-button.*", "sys.energy.*", "sys.voice.*", "sys.frame.*", "sys.state.*", "sys.momentum.*", "sys.tone.*", "sys.accessibility.*", "sys.symbol.*", "sys.growth.*", "sys.iconography.*", "sys.depth.*"],
    primitives: ["color", "typography", "spacing", "radius", "focus", "disabled", "duration", "motion-curves", "iconography", "message"],
    props: ["value", "label", "ariaLabel", "variant", "density", "state", "feedbackDuration", "copiedLabel", "errorLabel", "disabled", "loading", "icon", "type", "onCopied", "onCopyError"],
    jsSnippets: ["copyButtonPlatformContract", "React.createElement(Button", "React.createElement(IconButton", "className: [\"copy-button\"", 'flowVariantProps(resolvedVariant)', 'flowStateProps(resolvedState)', 'flowDensityProps(resolvedDensity)', '"data-copy-feedback"', "navigator.clipboard.writeText", "onCopied", "onCopyError"],
    typeSnippets: ["ForwardRefExoticComponent", "RefAttributes<HTMLButtonElement>", "CopyButtonProps", "CopyButtonVariant", "CopyButtonState", "CopyButtonDensity", "CopyButtonMeta", "copyButtonPlatformContract"],
    packagePath: "./copy-button",
    exportName: "CopyButton",
    propsName: "CopyButtonProps",
  },
  {
    id: "code-block",
    label: "Code Block",
    ...
    requiredTokens: ["comp.code-block.*", "comp.copy-button.*", "sys.energy.*", "sys.voice.*", "sys.frame.*", "sys.depth.*", "sys.state.*", "sys.momentum.*", "sys.tone.*", "sys.accessibility.*", "sys.symbol.*", "sys.growth.*", "sys.iconography.*"],
    ...
    jsSnippets: ["codeBlockPlatformContract", "React.createElement(CopyButton", "className: [\"code-block\"", 'flowVariantProps(resolvedVariant)', 'flowStateProps(resolvedState)', 'flowDensityProps(resolvedDensity)', '"data-wrap": wrap ? "true" : "false"', "code-block__header", "code-block__meta", "code-block__pre"],
  ...
  },
  {
    ...
    jsSnippets: ["datePickerPlatformContract", "className: [\"field date-picker\"", 'flowDensityProps(', '"data-open": String(open)', "date-picker__control", "date-picker__input", "date-picker__panel", "date-picker__grid", "date-picker__day", "formatDateLabel", "onValueChange", "onOpenChange"],
  ...
  },
  {
    ...
    primitives: ["color", "typography", "spacing", "radius", "focus", "disabled", "duration", "motion-curves", "iconography"],
    props: [],
    jsSnippets: ["iconButtonPlatformContract", "className: iconButtonClassName", '"aria-label": resolvedLabel', '"aria-pressed": selected ? "true"', 'flowDensityProps(', "icon-button__icon", "icon-button__badge"],
