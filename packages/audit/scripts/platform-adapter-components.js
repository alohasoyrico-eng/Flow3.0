const components = [
  ...
  },
  {
    ...
    jsSnippets: ["codeInputPlatformContract", "className: [\"field code-input\"", 'flowDensityProps(density)', 'flowVariantProps(variant)', '"data-focused": focused ? "true" : "false"', '"data-length": String(resolvedLength)', "normalizeCodeValue", "resolveCodeInputState", "code-input__control", "code-input__slots", "code-input__slot", "onComplete"],
  ...
  },
  {
    ...
    jsSnippets: ["segmentedControlPlatformContract", "className: [\"segmented-control\"", 'flowDensityProps(density)', 'flowVariantProps(variant)', "role: \"tablist\"", "segmented-control__indicator", "segmented-control__item", "segmented-control__icon", "segmented-control__label", "onValueChange", "ArrowRight", "ArrowLeft", "Home", "End"],
