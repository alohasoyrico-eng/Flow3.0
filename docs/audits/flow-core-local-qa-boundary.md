...
Generated: 2026-09-03T19:03:55.313Z
Status: pass
...
- localQaFiles: 41
- localQaComponents: 41
- localQaReactRuntimeFiles: 41
...
| --- | --- | ---: | --- |
| medium | Local QA harnesses include their own layout CSS. | 41 | Keep them local and out of repo; use them for human inspection, not as component source truth. |
