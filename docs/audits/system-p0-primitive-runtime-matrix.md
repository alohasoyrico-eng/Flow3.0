...
| Iconography | typed-policy-contract | no | `packages/components/src/primitives/iconography.js` | `packages/components/src/primitives/iconography.ts`<br>`packages/tokens/src/primitives/iconography.ts` | 48 | Iconography, Symbol, Accessibility, State, Energy |
| Library Sources | typed-policy-contract | no | `packages/components/src/primitives/library-sources.js` | `packages/components/src/primitives/library-sources.ts`<br>`packages/tokens/src/primitives/library-sources.ts` | 0 | Symbol, Iconography, Accessibility, Momentum, Energy, Frame |
| Country Flags | typed-policy-contract | no | `packages/components/src/primitives/country-flags.js` | `packages/components/src/primitives/country-flags.ts`<br>`packages/tokens/src/primitives/country-flags.ts` | 0 | Iconography, Symbol, Accessibility, Energy, Frame |
| Animation Assets | typed-policy-contract | no | `packages/components/src/primitives/animation-assets.js` | `packages/components/src/primitives/animation-assets.ts`<br>`packages/tokens/src/primitives/animation-assets.ts` | 0 | Momentum, Accessibility, Symbol, Energy, Frame |
| Illustration Assets | typed-policy-contract | no | `packages/components/src/primitives/illustration-assets.js` | `packages/components/src/primitives/illustration-assets.ts`<br>`packages/tokens/src/primitives/illustration-assets.ts` | 0 | Symbol, Accessibility, Energy, Frame, Voice |
...
| Charts | typed-runtime | yes | `packages/components/src/primitives/charts.js` | `packages/components/src/primitives/charts.ts`<br>`packages/tokens/src/primitives/charts.ts` | 0 | Energy, Accessibility, Momentum, Voice, State |
| Maps | typed-runtime | yes | `packages/components/src/primitives/maps.js` | `packages/components/src/primitives/maps.ts`<br>`packages/tokens/src/primitives/maps.ts` | 0 | Energy, Accessibility, Frame, Voice, Momentum, Depth, State |
