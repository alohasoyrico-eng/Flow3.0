...
| --- | --- | --- | --- | --- | --- | --- |
| accordion | navigation | single, multiple | default | closed, open, disabled | variant, density | disabled-state-without-disabled-prop |
...
| combobox | fields | default | default | default, open, focus, filled, empty, loading, error, disabled | state, density, disabled | loading-state-without-loading-prop |
...
| date-picker | fields-date | calendar | input | default, hover, focus, selected, warning, error, disabled | state, density, disabled | selected-state-without-selected-prop |
| date-range-picker | fields-date | calendar-range | input | default, hover, focus, selected, warning, error, disabled | state, density, disabled | selected-state-without-selected-prop |
...
| list | data-display | standard, compact, action, status, media | default | default, hover, selected, loading, error, disabled | variant, state, density | disabled-state-without-disabled-prop, loading-state-without-loading-prop, selected-state-without-selected-prop |
...
| select | fields | default, inline | default | default, open, focus, filled, loading, error, disabled | variant, state, density, disabled | loading-state-without-loading-prop |
...
| table | data-display | standard, dense, sortable, selectable, expandable | data | default, hover, focus, selected, sorted, expanded | variant, state, density | selected-state-without-selected-prop |
| tabs | navigation | default, underline | default | default, hover, selected, focus, overflow, disabled | variant, density | disabled-state-without-disabled-prop |
