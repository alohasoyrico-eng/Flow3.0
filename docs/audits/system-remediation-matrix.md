...
| foundation:depth | blocked | 29 | style-dictionary-real, typescript-source-real | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
| foundation:energy | blocked | 48 | style-dictionary-real, typescript-source-real | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
| foundation:frame | blocked | 59 | style-dictionary-real, typescript-source-real | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
...
| foundation:momentum | blocked | 18 | style-dictionary-real, typescript-source-real | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
| foundation:state | blocked | 132 | style-dictionary-real, typescript-source-real | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
| foundation:symbol | blocked | 24 | style-dictionary-real, typescript-source-real | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
| foundation:tone | blocked | 67 | style-dictionary-real, typescript-source-real | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
| foundation:voice | blocked | 40 | style-dictionary-real, typescript-source-real | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
...
| depth | blocked | 29 | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
| energy | blocked | 48 | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
| frame | blocked | 59 | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
...
| momentum | blocked | 18 | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
| state | blocked | 132 | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
| symbol | blocked | 24 | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
...
| voice | blocked | 40 | define canonical token/foundation source; no ad hoc docs-only visual behavior<br>convert implementation contract to real TypeScript source, not JS plus .d.ts<br>classify each docs hand-authored surface as consume Flow, docs-only content, merge, or delete |
