...
| P0.2 | Typed primitive runtime for missing primitives | complete | 17 | None | missing primitives have TS runtime or explicit non-runtime decision<br>surface/color/density/radius/elevation/focus/spacing/typography are available to higher layers<br>runtime without spec is classified | ../FlowDocs/apps/docs/icon-system.js (25)<br>../FlowDocs/apps/docs/primitive-reference.js (13)<br>../FlowDocs/apps/docs/primitive-tabs.js (5) |
...
| P0.4 | Shell pattern contracts | complete | 3 | None | topbar/sidebar/search contracts are TS-authored<br>docs shell behavior can consume Flow shell contracts<br>hamburger/search/dark-mode responsibilities are assigned to Flow or docs shell explicitly | ../FlowDocs/apps/docs/reference-demo-interactions.js (22)<br>../FlowDocs/apps/docs/component-demo-interactions.js (7)<br>../FlowDocs/apps/docs/template-desktop-interactions.js (5)<br>../FlowDocs/apps/docs/doc-interactions.js (4)<br>../FlowDocs/apps/docs/pattern-desktop-interactions.js (4)<br>../FlowDocs/apps/docs/button-playground-interactions.js (3)<br>../FlowDocs/apps/docs/docs-layout.js (3)<br>../FlowDocs/apps/docs/pattern-advanced-filter-interactions.js (3)<br>../FlowDocs/apps/docs/shell-controls.js (3)<br>../FlowDocs/apps/docs/index.html (2)<br>../FlowDocs/apps/docs/pattern-roles-permissions-interactions.js (2)<br>../FlowDocs/apps/docs/docs-chrome.js (1)<br>../FlowDocs/apps/docs/pattern-column-configurator-interactions.js (1)<br>../FlowDocs/apps/docs/pattern-journey-interactions.js (1)<br>../FlowDocs/apps/docs/pattern-mobile-interactions.js (1)<br>../FlowDocs/apps/docs/progress-indicator-demo-interactions.js (1)<br>../FlowDocs/apps/docs/stateful-component-interactions.js (1) |
| P0.5 | FlowDocs P0 duplicate cleanup | in_progress | 38 | FlowDocs non-shell duplicate/template/style hotspots remain | P0 docs surfaces are consume Flow, docs-owned content, merged, or removed<br>no P0 file is hand-implementing missing lower-layer behavior<br>forensic gates show reduced docs-hand-authored P0 count | ../FlowDocs/apps/docs/styles/03c-motion-reference-01.css (19)<br>../FlowDocs/apps/docs/styles/03a-reference-core-01.css (17)<br>../FlowDocs/apps/docs/styles/03b-foundation-reference-02.css (17)<br>../FlowDocs/apps/docs/styles/06-responsive-01.css (17)<br>../FlowDocs/apps/docs/styles/06-responsive-02.css (15)<br>../FlowDocs/apps/docs/pattern-tabs.js (12)<br>../FlowDocs/apps/docs/styles/01-shell-01.css (12)<br>../FlowDocs/apps/docs/styles/01-shell-02.css (12)<br>../FlowDocs/apps/docs/styles/07-pattern-settings-help.css (12)<br>../FlowDocs/apps/docs/styles/03a-reference-core-02.css (10)<br>../FlowDocs/apps/docs/styles/04b-card-docs.css (10)<br>../FlowDocs/apps/docs/gold-input-docs.js (9)<br>../FlowDocs/apps/docs/pattern-design-lead.js (9)<br>../FlowDocs/apps/docs/pattern-desktop-demos.js (9)<br>../FlowDocs/apps/docs/pattern-miel-tabs.js (9)<br>../FlowDocs/apps/docs/pattern-operational-demos.js (9)<br>../FlowDocs/apps/docs/pattern-shell-react-demos.js (9)<br>../FlowDocs/apps/docs/styles/01-shell-react.css (9)<br>../FlowDocs/apps/docs/styles/08-template-desktop-demos.css (9)<br>../FlowDocs/apps/docs/gold-text-area-docs.js (8) |
