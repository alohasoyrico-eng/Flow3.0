...
| CodeBlock | pass | Button | Button | None | None | None | None | None |
| Combobox | pass | Spinner | Spinner | None | None | None | None | None |
...
| CodeBlock | Button | governed copy action slot |
| Combobox | Spinner | field loading indicator slot |
