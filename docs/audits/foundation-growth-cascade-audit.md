...
| Pattern contract refs | 59 | account-operations, action-sheet, advanced-filters, agent-conversation, authentication-login-biometrics-and-otp, autocomplete, avatar-group, avatar-menu, backoffice-approval, bulk-actions, calendar-view, case-management, chart-wrapper, column-configurator, command-palette, confirmation-dialog, dense-operational-list, drag-sortable-list... |
| Pattern copy refs | 26 | account-operations, advanced-filters, agent-conversation, backoffice-approval, case-management, chart-wrapper, command-palette, dense-operational-list, email-template-layout, expandable-detail-table, filterable-editable-table, gantt-chart, help-center, kanban-board, multi-step-form, payment-form, polar-chart, preference-management... |
...
| Docs CSS direct uses | 12 | apps/docs/styles |
