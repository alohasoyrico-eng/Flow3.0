...
| Pattern contract refs | 70 | account-operations, action-sheet, advanced-filters, agent-conversation, artifact-metadata-bar, authentication-login-biometrics-and-otp, autocomplete, avatar-group, avatar-menu, backoffice-approval, bottom-sheet, bulk-actions, calendar-view, case-management, chart-legend-item, chart-wrapper, checkbox-group, column-configurator... |
| Pattern copy refs | 37 | account-operations, advanced-filters, agent-conversation, artifact-metadata-bar, backoffice-approval, bottom-sheet, case-management, chart-legend-item, chart-wrapper, checkbox-group, command-palette, demo-preview-frame, dense-operational-list, documentation-hero, documentation-primitive-demo, documentation-reference-grid, documentation-token-grid, email-template-layout... |
