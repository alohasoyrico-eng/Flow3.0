...
| foundation:depth | 29 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 4<br>docs-foundation-detail-renderer: 1<br>docs-pattern-detail-renderer: 3<br>docs-primitive-detail-renderer: 1<br>docs-dom-interaction: 1<br>docs-css-visual-surface: 19 |
| foundation:energy | 48 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 4<br>docs-foundation-detail-renderer: 3<br>docs-dom-interaction: 1<br>docs-css-visual-surface: 40 |
| foundation:frame | 59 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 7<br>docs-foundation-detail-renderer: 3<br>docs-dom-interaction: 2<br>docs-css-visual-surface: 47 |
...
| foundation:momentum | 18 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 3<br>docs-dom-interaction: 1<br>docs-css-visual-surface: 14 |
| foundation:state | 132 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 13<br>docs-dom-interaction: 11<br>docs-foundation-detail-renderer: 2<br>docs-component-detail-renderer: 60<br>docs-pattern-detail-renderer: 28<br>docs-primitive-detail-renderer: 2<br>docs-css-visual-surface: 13<br>docs-template-detail-renderer: 3 |
| foundation:symbol | 24 | parallel DOM behavior risk<br>docs-only visual surface risk<br>docs shell dependency risk<br>missing TypeScript source | docs-misc-surface: 6<br>docs-foundation-detail-renderer: 1<br>docs-shell: 1<br>docs-dom-interaction: 1<br>docs-css-visual-surface: 15 |
...
| foundation:voice | 40 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 3<br>docs-foundation-detail-renderer: 3<br>docs-pattern-detail-renderer: 1<br>docs-primitive-detail-renderer: 1<br>docs-dom-interaction: 1<br>docs-css-visual-surface: 31 |
...
| pattern:search | 48 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 5<br>docs-dom-interaction: 5<br>docs-component-detail-renderer: 2<br>docs-pattern-detail-renderer: 20<br>docs-css-visual-surface: 16 |
