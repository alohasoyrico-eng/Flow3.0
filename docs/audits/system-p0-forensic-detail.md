...
- Primitives: 24
- Shell patterns: 3
- P0 docs hand surface files counted with duplicates per entity: 1082

## P0 category matrix

| Ticket | Docs hand files | Risk flags | Surface categories |
| --- | ---: | --- | --- |
| foundation:accessibility | 69 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 7<br>docs-foundation-detail-renderer: 1<br>docs-component-detail-renderer: 57<br>docs-pattern-detail-renderer: 2<br>docs-dom-interaction: 1<br>docs-css-visual-surface: 1 |
| foundation:depth | 30 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 4<br>docs-foundation-detail-renderer: 1<br>docs-pattern-detail-renderer: 3<br>docs-primitive-detail-renderer: 1<br>docs-dom-interaction: 1<br>docs-css-visual-surface: 20 |
| foundation:energy | 50 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 4<br>docs-foundation-detail-renderer: 3<br>docs-dom-interaction: 1<br>docs-css-visual-surface: 42 |
| foundation:frame | 61 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 7<br>docs-foundation-detail-renderer: 3<br>docs-dom-interaction: 2<br>docs-css-visual-surface: 49 |
| foundation:growth | 11 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 3<br>docs-foundation-detail-renderer: 1<br>docs-dom-interaction: 1<br>docs-css-visual-surface: 5<br>docs-template-detail-renderer: 1 |
| foundation:iconography | 3 | docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 2<br>docs-css-visual-surface: 1 |
| foundation:momentum | 19 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 3<br>docs-dom-interaction: 1<br>docs-css-visual-surface: 15 |
| foundation:state | 133 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 13<br>docs-dom-interaction: 11<br>docs-foundation-detail-renderer: 2<br>docs-component-detail-renderer: 60<br>docs-pattern-detail-renderer: 28<br>docs-primitive-detail-renderer: 2<br>docs-css-visual-surface: 14<br>docs-template-detail-renderer: 3 |
| foundation:symbol | 26 | parallel DOM behavior risk<br>docs-only visual surface risk<br>docs shell dependency risk<br>missing TypeScript source | docs-misc-surface: 6<br>docs-foundation-detail-renderer: 1<br>docs-shell: 1<br>docs-dom-interaction: 1<br>docs-css-visual-surface: 17 |
| foundation:tone | 67 | parallel DOM behavior risk<br>docs-only visual surface risk<br>docs shell dependency risk<br>missing TypeScript source | docs-misc-surface: 12<br>docs-dom-interaction: 3<br>docs-shell: 1<br>docs-foundation-detail-renderer: 3<br>docs-component-detail-renderer: 15<br>docs-pattern-detail-renderer: 25<br>docs-primitive-detail-renderer: 1<br>docs-reference-renderer: 1<br>docs-css-visual-surface: 4<br>docs-template-detail-renderer: 2 |
| foundation:voice | 42 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 3<br>docs-foundation-detail-renderer: 3<br>docs-pattern-detail-renderer: 1<br>docs-primitive-detail-renderer: 1<br>docs-dom-interaction: 1<br>docs-css-visual-surface: 33 |
...
| primitive:color | 56 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing primitive runtime | docs-misc-surface: 6<br>docs-foundation-detail-renderer: 1<br>docs-pattern-detail-renderer: 4<br>docs-primitive-detail-renderer: 1<br>docs-dom-interaction: 1<br>docs-css-visual-surface: 43 |
| primitive:country-flags | 0 | None | None |
| primitive:density | 63 | parallel DOM behavior risk<br>docs-only visual surface risk<br>docs shell dependency risk<br>missing primitive runtime | docs-dom-interaction: 3<br>docs-misc-surface: 4<br>docs-shell: 1<br>docs-foundation-detail-renderer: 3<br>docs-component-detail-renderer: 16<br>docs-home-renderer: 1<br>docs-pattern-detail-renderer: 10<br>docs-primitive-detail-renderer: 2<br>docs-css-visual-surface: 22<br>docs-template-detail-renderer: 1 |
| primitive:disabled | 28 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing primitive runtime | docs-misc-surface: 6<br>docs-component-detail-renderer: 7<br>docs-dom-interaction: 4<br>docs-pattern-detail-renderer: 3<br>docs-primitive-detail-renderer: 1<br>docs-css-visual-surface: 6<br>docs-template-detail-renderer: 1 |
...
| primitive:elevation | 45 | docs-only visual surface risk<br>missing primitive runtime | docs-misc-surface: 6<br>docs-foundation-detail-renderer: 1<br>docs-component-detail-renderer: 1<br>docs-pattern-detail-renderer: 17<br>docs-primitive-detail-renderer: 2<br>docs-reference-renderer: 1<br>docs-css-visual-surface: 15<br>docs-template-detail-renderer: 2 |
| primitive:field-action | 0 | missing primitive runtime | None |
| primitive:focus | 35 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing primitive runtime | docs-misc-surface: 7<br>docs-dom-interaction: 4<br>docs-component-detail-renderer: 5<br>docs-pattern-detail-renderer: 4<br>docs-primitive-detail-renderer: 1<br>docs-css-visual-surface: 14 |
...
| primitive:radius | 52 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing primitive runtime | docs-dom-interaction: 2<br>docs-misc-surface: 5<br>docs-component-detail-renderer: 1<br>docs-primitive-detail-renderer: 1<br>docs-css-visual-surface: 43 |
...
| primitive:surface | 88 | docs-only visual surface risk<br>missing primitive runtime | docs-misc-surface: 9<br>docs-foundation-detail-renderer: 2<br>docs-component-detail-renderer: 11<br>docs-pattern-detail-renderer: 18<br>docs-primitive-detail-renderer: 2<br>docs-reference-renderer: 1<br>docs-css-visual-surface: 43<br>docs-template-detail-renderer: 2 |
...
| pattern:search | 49 | parallel DOM behavior risk<br>docs-only visual surface risk<br>missing TypeScript source | docs-misc-surface: 5<br>docs-dom-interaction: 5<br>docs-component-detail-renderer: 2<br>docs-pattern-detail-renderer: 20<br>docs-css-visual-surface: 17 |
| pattern:sidebar | 17 | parallel DOM behavior risk<br>docs-only visual surface risk<br>docs shell dependency risk<br>missing TypeScript source | docs-dom-interaction: 2<br>docs-shell: 1<br>docs-misc-surface: 1<br>docs-pattern-detail-renderer: 8<br>docs-css-visual-surface: 5 |
| pattern:topbar | 20 | parallel DOM behavior risk<br>docs-only visual surface risk<br>docs shell dependency risk<br>missing TypeScript source | docs-shell: 2<br>docs-misc-surface: 1<br>docs-component-detail-renderer: 1<br>docs-pattern-detail-renderer: 6<br>docs-dom-interaction: 1<br>docs-css-visual-surface: 9 |
