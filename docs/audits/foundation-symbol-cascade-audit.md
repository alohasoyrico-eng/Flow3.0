...
| Pattern refs | 38 | account-operations, action-sheet, advanced-filters, agent-conversation, authentication-login-biometrics-and-otp, autocomplete, avatar-group, backoffice-approval, calendar-view, case-management, chart-wrapper, column-configurator, command-palette, dense-operational-list, drawer-adapter, driver-onboarding-mobile, email-template-layout, expandable-detail-table... |
