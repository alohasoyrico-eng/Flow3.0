...
| Pattern refs | 41 | account-operations, action-sheet, advanced-filters, agent-conversation, authentication-login-biometrics-and-otp, autocomplete, avatar-group, backoffice-approval, bottom-sheet, calendar-view, case-management, chart-wrapper, checkbox-group, column-configurator, command-palette, dense-operational-list, drawer-adapter, driver-onboarding-mobile... |
