...
| internal-operations-console | loaded-sm | pass | desktop 1280x900 | loaded | sm | 15 | 74 | captured |
| internal-operations-console | loading-md | pass | desktop 1280x900 | loading | md | 15 | 74 | captured |
| internal-operations-console | permission-lg | pass | desktop 1280x900 | permission | lg | 15 | 71 | captured |
| agent-workspace | loaded-sm | pass | desktop 1280x900 | loaded | sm | 10 | 28 | captured |
| agent-workspace | loading-md | pass | desktop 1280x900 | loading | md | 8 | 26 | captured |
| agent-workspace | permission-lg | pass | desktop 1280x900 | permission | lg | 8 | 25 | captured |
| configuration-console | loaded-sm | pass | desktop 1280x900 | loaded | sm | 8 | 64 | captured |
| configuration-console | loading-md | pass | desktop 1280x900 | loading | md | 8 | 58 | captured |
| configuration-console | permission-lg | pass | desktop 1280x900 | permission | lg | 8 | 60 | captured |
| fleet-dashboard-suite | loaded-sm | pass | desktop 1280x900 | loaded | sm | 9 | 41 | captured |
| fleet-dashboard-suite | loading-md | pass | desktop 1280x900 | loading | md | 9 | 41 | captured |
| fleet-dashboard-suite | permission-lg | pass | desktop 1280x900 | permission | lg | 9 | 43 | captured |
| fleet-manager-desktop | loaded-sm | pass | desktop 1280x900 | loaded | sm | 7 | 49 | captured |
| fleet-manager-desktop | loading-md | pass | desktop 1280x900 | loading | md | 7 | 49 | captured |
| fleet-manager-desktop | permission-lg | pass | desktop 1280x900 | permission | lg | 7 | 51 | captured |
