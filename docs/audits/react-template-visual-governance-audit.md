...
| internal-operations-console | loaded-sm | pass | desktop 1280x900 | loaded | sm | 15 | 67 | captured |
| internal-operations-console | loading-md | pass | desktop 1280x900 | loading | md | 15 | 67 | captured |
| internal-operations-console | permission-lg | pass | desktop 1280x900 | permission | lg | 15 | 64 | captured |
...
| configuration-console | loaded-sm | pass | desktop 1280x900 | loaded | sm | 8 | 57 | captured |
| configuration-console | loading-md | pass | desktop 1280x900 | loading | md | 8 | 51 | captured |
| configuration-console | permission-lg | pass | desktop 1280x900 | permission | lg | 8 | 53 | captured |
| fleet-dashboard-suite | loaded-sm | pass | desktop 1280x900 | loaded | sm | 9 | 34 | captured |
| fleet-dashboard-suite | loading-md | pass | desktop 1280x900 | loading | md | 9 | 34 | captured |
| fleet-dashboard-suite | permission-lg | pass | desktop 1280x900 | permission | lg | 9 | 36 | captured |
