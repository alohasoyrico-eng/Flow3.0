...
| internal-operations-console | loaded-sm-controlled | pass | loaded | sm | tickets | 69 |
| internal-operations-console | loading-md | pass | loading | md | cases | 67 |
| internal-operations-console | empty-md | pass | empty | md | cases | 67 |
| internal-operations-console | permission-lg | pass | permission | lg | cases | 64 |
| internal-operations-console | error-sm | pass | error | sm | cases | 67 |
| internal-operations-console | offline-md | pass | offline | md | cases | 67 |
| internal-operations-console | disabled-lg | pass | disabled | lg | cases | 62 |
| internal-operations-console | uncontrolled-default | pass | loaded | md | pricing | 69 |
...
| configuration-console | loaded-sm-controlled | pass | loaded | sm | drivers | 59 |
| configuration-console | loading-md | pass | loading | md | permissions | 51 |
| configuration-console | empty-md | pass | empty | md | permissions | 57 |
| configuration-console | permission-lg-with-authentication | pass | permission | lg | permissions | 60 |
| configuration-console | error-sm | pass | error | sm | permissions | 49 |
...
| fleet-dashboard-suite | loaded-sm-controlled | pass | loaded | sm | finance | 36 |
| fleet-dashboard-suite | loading-md | pass | loading | md | overview | 34 |
| fleet-dashboard-suite | empty-md | pass | empty | md | overview | 34 |
| fleet-dashboard-suite | permission-lg | pass | permission | lg | overview | 36 |
| fleet-dashboard-suite | error-sm | pass | error | sm | overview | 34 |
| fleet-dashboard-suite | offline-md | pass | offline | md | overview | 34 |
| fleet-dashboard-suite | disabled-lg | pass | disabled | lg | overview | 34 |
| fleet-dashboard-suite | uncontrolled-default | pass | loaded | md | ev | 36 |
| fleet-manager-desktop | loaded-sm-controlled | pass | loaded | sm | fuel | 44 |
| fleet-manager-desktop | loading-md | pass | loading | md | overview | 42 |
| fleet-manager-desktop | empty-md | pass | empty | md | overview | 42 |
| fleet-manager-desktop | permission-lg | pass | permission | lg | overview | 44 |
| fleet-manager-desktop | error-sm | pass | error | sm | overview | 42 |
| fleet-manager-desktop | offline-md | pass | offline | md | overview | 42 |
| fleet-manager-desktop | disabled-lg | pass | disabled | lg | overview | 42 |
| fleet-manager-desktop | uncontrolled-default | pass | loaded | md | fleet | 44 |
