...
| internal-operations-console | loaded-sm-controlled | pass | loaded | sm | tickets | 74 |
| internal-operations-console | loading-md | pass | loading | md | cases | 74 |
| internal-operations-console | empty-md | pass | empty | md | cases | 74 |
| internal-operations-console | permission-lg | pass | permission | lg | cases | 71 |
| internal-operations-console | error-sm | pass | error | sm | cases | 74 |
| internal-operations-console | offline-md | pass | offline | md | cases | 74 |
| internal-operations-console | disabled-lg | pass | disabled | lg | cases | 69 |
| internal-operations-console | uncontrolled-default | pass | loaded | md | pricing | 74 |
| agent-workspace | loaded-sm-controlled | pass | loaded | sm | route-help | 28 |
| agent-workspace | loading-md | pass | loading | md | handoff | 26 |
| agent-workspace | empty-md | pass | empty | md | handoff | 28 |
| agent-workspace | permission-lg | pass | permission | lg | handoff | 25 |
| agent-workspace | error-sm | pass | error | sm | handoff | 24 |
| agent-workspace | offline-md | pass | offline | md | handoff | 24 |
| agent-workspace | disabled-lg | pass | disabled | lg | handoff | 24 |
| agent-workspace | uncontrolled-default | pass | handoff | md | receipt | 28 |
| configuration-console | loaded-sm-controlled | pass | loaded | sm | drivers | 64 |
| configuration-console | loading-md | pass | loading | md | permissions | 58 |
| configuration-console | empty-md | pass | empty | md | permissions | 64 |
| configuration-console | permission-lg-with-authentication | pass | permission | lg | permissions | 67 |
| configuration-console | error-sm | pass | error | sm | permissions | 56 |
| configuration-console | offline-md | pass | offline | md | permissions | 56 |
| configuration-console | disabled-lg | pass | disabled | lg | permissions | 64 |
| configuration-console | uncontrolled-default | pass | loaded | md | vehicles | 64 |
...
| fleet-dashboard-suite | loaded-sm-controlled | pass | loaded | sm | finance | 41 |
| fleet-dashboard-suite | loading-md | pass | loading | md | overview | 41 |
| fleet-dashboard-suite | empty-md | pass | empty | md | overview | 41 |
| fleet-dashboard-suite | permission-lg | pass | permission | lg | overview | 43 |
| fleet-dashboard-suite | error-sm | pass | error | sm | overview | 41 |
| fleet-dashboard-suite | offline-md | pass | offline | md | overview | 41 |
| fleet-dashboard-suite | disabled-lg | pass | disabled | lg | overview | 41 |
| fleet-dashboard-suite | uncontrolled-default | pass | loaded | md | ev | 41 |
| fleet-manager-desktop | loaded-sm-controlled | pass | loaded | sm | fuel | 49 |
| fleet-manager-desktop | loading-md | pass | loading | md | overview | 49 |
| fleet-manager-desktop | empty-md | pass | empty | md | overview | 49 |
| fleet-manager-desktop | permission-lg | pass | permission | lg | overview | 51 |
| fleet-manager-desktop | error-sm | pass | error | sm | overview | 49 |
| fleet-manager-desktop | offline-md | pass | offline | md | overview | 49 |
| fleet-manager-desktop | disabled-lg | pass | disabled | lg | overview | 49 |
| fleet-manager-desktop | uncontrolled-default | pass | loaded | md | fleet | 49 |
