...
| internal-operations-console | loaded-sm-controlled | pass | loaded | sm | tickets | 72 |
...
| internal-operations-console | uncontrolled-default | pass | loaded | md | pricing | 72 |
...
| configuration-console | loaded-sm-controlled | pass | loaded | sm | drivers | 62 |
...
| configuration-console | uncontrolled-default | pass | loaded | md | vehicles | 62 |
...
| fleet-dashboard-suite | loaded-sm-controlled | pass | loaded | sm | finance | 39 |
...
| fleet-dashboard-suite | uncontrolled-default | pass | loaded | md | ev | 39 |
| fleet-manager-desktop | loaded-sm-controlled | pass | loaded | sm | fuel | 47 |
...
| fleet-manager-desktop | uncontrolled-default | pass | loaded | md | fleet | 47 |
